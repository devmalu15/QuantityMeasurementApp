    ...
    public static class LengthUnitExtensions
    {
        public static double ToFeetFactor(this LengthUnit u)
        {
            switch (u)
            {
                ...
                case LengthUnit.Centimeter: return 0.393701 / 12.0;
                default: throw new ArgumentOutOfRangeException(nameof(u));
            }
        }

        public static double ConvertToBaseUnit(this LengthUnit u, double value) => value * u.ToFeetFactor();
        public static double ConvertFromBaseUnit(this LengthUnit u, double baseValue) => baseValue / u.ToFeetFactor();
    }
}
